...
const Features = () => {
  return (
    <section className="pt-[50px] xl:pt-[160px] md:flex-r items-center gap-12" id="tentang">
      <div className="container mx-auto">
        ...
        <div className="xl:mt-20 flex flex-col xl:flex-row h-full xl:gap-[90px]">
          ...
          <div className="flex-1 space-y-5 mt-[50px]">
            ...
            <span className="text-accent">Perjalanan kami dimulai</span> dari Satu misi sederhana
            </h2>
