...
const Hero = () => {
  return (
    <section
      className="w-full h-[900px] xl:h-[695px] pb-[400px] xl:pb-[30px] relative bg-gray-100"
      id="home"
    >
      <div className="container mx-auto h-full">
        ...
        >
          ...
          <h1 className="h1 tracking-[1.5px] mt-8 xl:mt-1 uppercase font-bold mb-1 max-w-[320px] xl:max-w-none">
